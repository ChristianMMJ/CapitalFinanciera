...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spS_ValidarInversionEnUso' AND
			TYPE = 'P')
	DROP PROCEDURE web_spS_ValidarInversionEnUso
GO
-- =============================================
-- Author:		Orlando Esparza
-- Create date: Domingo 31 de Marzo de 2019
-- Description:	Validar si es posible eliminar un registro de Inversion por su ID
-- =============================================
CREATE PROCEDURE web_spS_ValidarInversionEnUso
