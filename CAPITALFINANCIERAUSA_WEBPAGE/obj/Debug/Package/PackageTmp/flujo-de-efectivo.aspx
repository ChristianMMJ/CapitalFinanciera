            ...
            <div class="col-md-3">
                <div class="single-service-left">
                    <div class="single-service-widget">
                        <ul>
                            <li>
                                <a href="ganancias-de-capital.aspx">Ganancias de capital
                                       
                                    <i class="fa fa-angle-right"></i>
                                </a>
                            </li>
                            <li class="active">
                                <a href="flujo-de-efectivo.aspx">Flujo de efectivo
            ...
            <div class="col-md-9">
                <div class="single-service-right">
                    ...
                    <div class="audit-text">
                        ...
                        <p>¿Sabías que con <b>Capital Financiera</b> puedes acceder a tener Rentas Mensuales durante años sin necesidad de preocuparte por inquilinos, administración ni mantenimiento?</p>
                        ...
                        <p>Normalmente en México y Latinoamérica, si compras una casa de contado para vivir de tus rentas estarás recibiendo entre el 4% y 6% al año de ganancias, pagadas cada mes sería entre 0.33% y 0.5% del total de tu inversión. Además, estás a expensas de tardanza en la cobranza de la renta, mudanzas de inquilinos, mantenimiento y posible destrucción de la propiedad, etc.</p>
                        <p>De la mano de <b>Capital Financiera</b>desde 25,000 dólares puedes acceder al 1% de renta al mes. Al año sería el 12%. Ganarías el doble o triple cada mes, con Bienes Raíces de Estados Unidos, Bienes Raíces en el Primer Mundo. </p>
                        <p>
                            Aprovecha esta gran oportunidad y ahora sí vive de tus rentas.
                            <br>
                            <ul>
                                <strong>
                                    <li>Sin salir de tu País</li>
                                </strong>
                                <strong>
                                    <li>Sin ser ciudadano o residente norteamericano</li>
                                </strong>
                                <strong>
                                    <li>Sin visa</li>
                                </strong>
                                <strong>
                                    <li>Sin saber inglés</li>
                                </strong>
                                <strong>
                                    <li>Sin dejar tu trabajo o negocio actual</li>
                                    <li></li>
                                </strong>
                            </ul>
                        </p>
