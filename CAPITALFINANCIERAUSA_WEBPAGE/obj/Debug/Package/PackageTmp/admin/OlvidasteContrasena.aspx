<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OlvidasteContrasena.aspx.cs" Inherits="CAPITALFINANCIERAUSA_WEBPAGE.admin.OlvidasteContrasena" %>
                        ...
                        <ext:FieldSet
                            ...
                            <Items>
                                ...
                                <ext:FieldContainer
                                    ID="fcCorreo"
                                    runat="server" 
                                    FieldLabel=" Puede que tengas que ver en tu carpeta de spam o desbloquear contacto@capitalfinancierausa.com" 
                                    Layout="HBoxLayout"
                                    LabelWidth="380">
                                </ext:FieldContainer>
                            </Items>
