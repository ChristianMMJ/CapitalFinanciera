<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Galeria1.aspx.cs" Inherits="CAPITALFINANCIERAUSA_WEBPAGE.Galeria1" %>
                    ...
                    <div class="single-service-right">
                        ...
                        <div class="audit-text">
                            ...
                            <div class="col-md-12">
                                <div class="audit-text">
                                    ...
                                    <br/>
                                    <h4>Antes y después de la restauración</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/fresno_1/1.jpg" class="gallery-lightbox">
                                                <img alt="1" src="galeria_casas/fresno_1/1.jpg"  />
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/fresno_1/2.jpg" class="gallery-lightbox">
                                                <img alt="2" src="galeria_casas/fresno_1/2.jpg" />
                                                <div class="product-overlay">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/3.jpg" class="gallery-lightbox">
                                            <img alt="3" src="galeria_casas/fresno_1/3.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/4.jpg" class="gallery-lightbox">
                                            <img alt="4" src="galeria_casas/fresno_1/4.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/5.jpg" class="gallery-lightbox">
                                            <img alt="5" src="galeria_casas/fresno_1/5.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/6.jpg" class="gallery-lightbox">
                                            <img alt="6" src="galeria_casas/fresno_1/6.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/7.jpg" class="gallery-lightbox">
                                            <img alt="7" src="galeria_casas/fresno_1/7.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/8.jpg" class="gallery-lightbox">
                                            <img alt="8" src="galeria_casas/fresno_1/8.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/fresno_1/9.jpg" class="gallery-lightbox">
                                            <img alt="9" src="galeria_casas/fresno_1/9.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
