<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Galeria6.aspx.cs" Inherits="CAPITALFINANCIERAUSA_WEBPAGE.Galeria6" %>
                    ...
                    <div class="single-service-right">
                        ...
                        <div class="audit-text">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/jade/jade1.jpg" class="gallery-lightbox">
                                                <img src="galeria_casas/jade/jade1.jpg"  />
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/jade/jade2.jpg" class="gallery-lightbox">
                                                <img src="galeria_casas/jade/jade2.jpg" />
                                                <div class="product-overlay">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                            </a>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/jade/jade3.jpg" class="gallery-lightbox">
                                                <img src="galeria_casas/jade/jade3.jpg" />
                                                <div class="product-overlay">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade4.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade4.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade5.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade5.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade6.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade6.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade7.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade7.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade8.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade8.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade9.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade9.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade10.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade10.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade11.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade11.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade12.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade12.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade13.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade13.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade14.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade14.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade15.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade15.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade16.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade16.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade17.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade17.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade18.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade18.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade19.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade19.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade20.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade20.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade21.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade21.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade22.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade22.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/jade/jade23.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/jade/jade23.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
