<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Galeria2.aspx.cs" Inherits="CAPITALFINANCIERAUSA_WEBPAGE.Galeria2" %>
                    ...
                    <div class="single-service-right">
                        ...
                        <div class="audit-text">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/casab/1.jpg" class="gallery-lightbox">
                                                <img src="galeria_casas/casab/1.jpg"  />
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="single-product">
                                        <div class="single-product-img">
                                            <a href="galeria_casas/casab/2.jpg" class="gallery-lightbox">
                                                <img src="galeria_casas/casab/2.jpg" />
                                                <div class="product-overlay">
                                                    <i class="fa fa-search"></i>
                                                </div>
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/casab/3.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/casab/3.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/casab/4.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/casab/4.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/casab/5.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/casab/5.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/casab/6.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/casab/6.jpg" />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="single-product">
                                    <div class="single-product-img">
                                        <a href="galeria_casas/casab/7.jpg" class="gallery-lightbox">
                                            <img src="galeria_casas/casab/7.jpg"  />
                                            <div class="product-overlay">
                                                <i class="fa fa-search"></i>
                                            </div>
                                        </a>
