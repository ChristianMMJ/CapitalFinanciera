...
---------------------------------------------------------
  <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4" style="text-align:center; margin:30px 0;" align="right">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvCasa1">
                    <img alt="casa01" src="galeria_casas/portadaa.jpg" width="200" height="360" /></a>
                </div>
                <div class="col-md-4" style="text-align:center; margin:30px 0;">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvCasa2">
                    <img alt="casa02" src="galeria_casas/portadaweb.jpg" width="200" height="360" /></a>
                </div>
                <div class="col-md-4" style="text-align:center; margin:30px 0;">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvCasa3">
                    <img alt="casa02" src="galeria_casas/portada_carol.jpg" width="200" height="360" /></a>
                </div>
            </div>
           
            <div class="row">
                <div class="col-md-4" style="text-align:center; margin:30px 0;">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvFondear1"><img alt="casa01" src="galeria_casas/portada- darden.jpg" width="200" height="360" /></a>
                </div>
                <div class="col-md-4" style="text-align:center; margin:30px 0;">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvFondear2"><img alt="casa01" src="galeria_casas/portada-gran-lac- ave.jpg" width="200" height="360" /></a>
                </div>
                <div class="col-md-4" style="text-align:center; margin:30px 0;">
                    <a data-toggle="modal" style="cursor:pointer;" data-target="#InvFondear3"><img alt="casa01" src="galeria_casas/portada-jade-cir.jpg" width="200" height="360" /></a>
                </div>
            </div>
                        ...
                        <div id="InvCasa1Carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="galeria_casas/casaa/1.jpg" alt="..." />
                                </div>
                                <div class="item">
                                    <img src="galeria_casas/casaa/2.jpg" alt="..." />
                                </div>
                                <div class="item">
                                    <img src="galeria_casas/casaa/3.jpg" alt="..." />
                                </div>
                                <div class="item">
                                    <img src="galeria_casas/casaa/4.jpg" alt="..." />
                                </div>
                                <div class="item">
                                    <img src="galeria_casas/casaa/5.jpg" alt="..." />
                                </div>
                                <div class="item">
                                    <img src="galeria_casas/casaa/6.jpg" alt="..." />
                                </div>
                                 <div class="item">
                                    <img src="galeria_casas/casaa/7.jpg" alt="..." />
                                    </div>
                                     <div class="item">
                                    <img src="galeria_casas/casaa/8.jpg" alt="..." />
                                     </div>
                                     <div class="item">
                                    <img src="galeria_casas/casaa/9.jpg" alt="..." />
                                     </div>
                                </div>
                                </div>
                                </div>
